 ...
 * 
 */
public class PullAndLoadSwipeListView extends
	...
	public PullAndLoadSwipeListView(Context context) {
		super(context);
	}

	public PullAndLoadSwipeListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PullAndLoadSwipeListView(Context context, Mode mode) {
		super(context, mode);
	}
	...
	protected SwipeListView createSwipeListView(Context context,
			AttributeSet attrs) {
...
//		lv = new SwipeListView(context, attrs);
		return lv;
	}
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(PullAndLoadSwipeListView.this,
	...
	protected class InternalListView extends SwipeListView implements
		...
		public void setEmptyView(View emptyView) {
			PullAndLoadSwipeListView.this.setEmptyView(emptyView);
		}
