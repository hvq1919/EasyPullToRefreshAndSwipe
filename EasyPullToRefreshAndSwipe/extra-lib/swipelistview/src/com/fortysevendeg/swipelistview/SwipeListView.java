...
public class SwipeListView extends ListView {
	 ...
	 * (AN)
	 * 
	 * Allow Swipe right or left in each item
	 * */

	public final static int DISABLE_SWIPE_LEFT = -11111;
	public final static int DISABLE_SWIPE_RIGHT = -11113;
	public final static int DISABLE_SWIPE = -11114;
	public final static int ALLOW_SWIPE = 123345;

	public final static int SCROLL_STATE_NORMAL = 0;
	public final static int SCROLL_STATE_NOCLOSE_SWIPED = SCROLL_STATE_NORMAL + 1;

	private int m_nScrollState = SCROLL_STATE_NORMAL;
	...
	/**
	 * Can not swipe item over offset
	 * */
	private boolean mBIsRestrictedByOffset;
	...
	private void init(AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			mBIsRestrictedByOffset = styled.getBoolean(R.styleable.SwipeListView_swipeRestrictedByOffset, false);
		}
		...
		touchListener.setmBIsRestrictedByOffset(mBIsRestrictedByOffset);
	 ...
	 *            back item clicked
	 */
	protected void onClickBackView(int position,View view) {
		if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
			swipeListViewListener.onClickBackView(position,view);
		}
	}
	 ...
	 *            If open from right
	 */
	protected void onClosed(View view,int position, boolean fromRight) {
		if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
			swipeListViewListener.onClosed(view,position, fromRight);
		}
	}
	...
	public boolean CheckItemOpened(int position) {
		return touchListener.isItemOpened(position);
	}
	...
	public int getM_nScrollState() {
		return m_nScrollState;
	}

	public void setM_nScrollState(int m_nScrollState) {
		this.m_nScrollState = m_nScrollState;
	}
