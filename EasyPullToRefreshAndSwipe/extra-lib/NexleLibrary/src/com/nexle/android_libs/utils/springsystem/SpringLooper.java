...
public abstract class SpringLooper {
	 ...
	 * 
	 * @param springSystem
	 *            the spring system to call loop on.
	 */
	...
	/**
	 * The BaseSpringSystem has requested that the looper begins running this {@link Runnable} on every frame. The
	 * {@link Runnable} will continue running on every frame until {@link #stop()} is called. If an existing
	 * {@link Runnable} had been started on this looper, it will be cancelled.
	 */
