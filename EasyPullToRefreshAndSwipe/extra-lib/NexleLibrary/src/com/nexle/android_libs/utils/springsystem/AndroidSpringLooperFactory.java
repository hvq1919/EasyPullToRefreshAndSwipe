...
/**
 * Android version of the spring looper that uses the most appropriate frame callback mechanism available. It uses
 * Android's {@link Choreographer} when available, otherwise it uses a {@link Handler}.
 */
abstract class AndroidSpringLooperFactory {
	...
	/**
	 * The base implementation of the Android spring looper, using a {@link Handler} for the frame callbacks.
	 */
	...
	/**
	 * The Jelly Bean and up implementation of the spring looper that uses Android's {@link Choreographer} instead of a
	 * {@link Handler}
	 */
