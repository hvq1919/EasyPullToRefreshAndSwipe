 ...
 * @author shiki
 */
public class SAutoBgImageView extends ImageView {

	public SAutoBgImageView(Context context) {
		super(context);
	}

	public SAutoBgImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SAutoBgImageView(Context context, AttributeSet attrs, int defStyle) {
