...
/**
 * This custom layout paints a drop shadow behind all children. The size and opacity of the drop shadow is determined by
 * a "depth" factor that can be set and animated.
 */
public class ShadowLayout extends RelativeLayout {
	...
	/**
	 * The "depth" factor determines the offset distance and opacity of the shadow (shadows that are further away from
	 * the source are offset greater and are more translucent).
	 * 
	 * @param depth
	 */
	...
	/**
	 * Overriding onDraw allows us to draw shadows behind every child of this container. onDraw() is called to draw a
	 * layout's content before the children are drawn, so the shadows will be drawn first, behind the children (which is
	 * what we want).
	 */
	@Override
...
//
//		canvas.drawRect(SHADOW_RADIUS / 2.0f, SHADOW_RADIUS / 2.0f, containerWidth - SHADOW_RADIUS / 2.0f,
//				containerHeight - SHADOW_RADIUS / 2.0f, SHADOW_PAINT);
//	}
}